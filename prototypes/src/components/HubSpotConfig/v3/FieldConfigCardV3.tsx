...
interface FieldConfigCardV3Props {
...
export function FieldConfigCardV3({
  property,
  config,
  onConfigChange,
  onRemove,
  ...
  const availableDependencies = availableProperties.filter((p) => p.name !== property.name);
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground font-normal">
                Describe what value should be written.
              </span>
            </label>
            <textarea
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg border bg-muted/30">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Use the current HubSpot value as context before updating.
              </p>
            </div>
          </div>
